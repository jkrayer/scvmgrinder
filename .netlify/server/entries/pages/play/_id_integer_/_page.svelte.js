import { c as create_ssr_component, f as compute_rest_props, h as spread, k as escape_attribute_value, i as escape_object, b as add_attribute, a as subscribe, e as escape, v as validate_component, n as null_to_empty, l as createEventDispatcher, d as each } from "../../../../chunks/ssr.js";
...
const Armor = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="row" style="align-items:center;"><div class="col-one"><div class="row"><div class="score-title armor-formula svelte-b9giuy">${typeof $EquippedArmor.formula === "number" ? `-${escape($EquippedArmor.formula)}` : `-${escape($EquippedArmor.formula.join(""))}`}</div> ${typeof $EquippedArmor.formula !== "number" ? `${validate_component(RollButton, "RollButton").$$render($$result, { dice: $EquippedArmor.formula }, {}, {})}` : ``}</div></div> <div class="col-two"><div class="row" style="align-items:center;"><h2 class="sheet-title" data-svelte-h="svelte-1rloamw">Armor</h2> ${escape($EquippedArmor.title)}</div></div> <div class="col-one">${$EquippedArmor.armor !== null ? `<div class="row row-right"><div class="btn-col svelte-b9giuy"><button class="${[
    "btn primary button-tier svelte-b9giuy",
    getTier($EquippedArmor.armor.armor) === 1 ? "active" : ""
  ].join(" ").trim()}" ${1 > getMaxTier($EquippedArmor.armor.armor) ? "disabled" : ""} type="button">1</button></div> <div class="btn-col svelte-b9giuy"><button class="${[
    "btn primary button-tier svelte-b9giuy",
    getTier($EquippedArmor.armor.armor) === 2 ? "active" : ""
  ].join(" ").trim()}" ${2 > getMaxTier($EquippedArmor.armor.armor) ? "disabled" : ""} type="button">2</button></div> <div class="btn-col svelte-b9giuy"><button class="${[
    "btn primary button-tier svelte-b9giuy",
    getTier($EquippedArmor.armor.armor) === 3 ? "active" : ""
  ].join(" ").trim()}" ${3 > getMaxTier($EquippedArmor.armor.armor) ? "disabled" : ""} type="button">3</button></div></div>` : ``}</div> </div>`;
});
...
const EquipmentItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return ` ${eq === null ? `<div class="${escape(null_to_empty(classes), true) + " svelte-16h5k0w"}"></div>` : `<div class="${escape(null_to_empty(classes), true) + " svelte-16h5k0w"}"${add_attribute("title", eq.name, 0)}><div class="${["buttons svelte-16h5k0w", ""].join(" ").trim()}">${validate_component(SquareButton, "SquareButton").$$render($$result, { title: "Details" }, {}, {
    default: () => {
    ...
    return ` ${validate_component(SquareButton, "SquareButton").$$render($$result, { title }, {}, {
      default: () => {
  ...
  })}</div> <div class="${["copy", ""].join(" ").trim()}">${escape(eq.name)}</div></div>`}`;
});
...
const Incrementer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="row hp-row svelte-1b2v9js"><div><div class="label">${escape(title)}</div> <p class="title">${slots.default ? slots.default({}) : ``}</p></div> <div class="button-col">${validate_component(SquareButton, "SquareButton").$$render($$result, { icon: "plus" }, {}, {})} ${validate_component(SquareButton, "SquareButton").$$render($$result, { color: "secondary", icon: "minus" }, {}, {})}</div> </div>`;
});
...
const Equipment = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div id="equipment" class="svelte-1jun86g"><div class="row svelte-1jun86g" data-svelte-h="svelte-zfp1l5"><h2 class="sheet-title col-two">Equipment</h2>  <p class="rule col-two svelte-1jun86g">Strength + 8 items or DR+2 on Agility<wbr>/<wbr>Strength tests</p></div> <ul class="inventory-list clear-list svelte-1jun86g">${each(inventory, (eq, index) => {
    return `<li class="inventory-slot svelte-1jun86g">${validate_component(EquipmentItem, "EquipmentItem").$$render($$result, { eq, encumbered: index > encumbranceIndex }, {}, {})} </li>`;
  })}</ul> <div class="row svelte-1jun86g"><div class="col-two"> ${validate_component(Incrementer, "Incrementer").$$render($$result, { title: "Silver" }, {}, {
    default: () => {
...
const Features = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<h2 class="sheet-title" data-svelte-h="svelte-xvwd5i">Features</h2> <ul class="clear-list row">${each($Character.description, (d) => {
    return `<li class="col-two">${d.indexOf(":") > -1 ? (() => {
      let m = d.split(":");
      return ` <span class="prefix svelte-1s7su8k">${escape(m[0])}:</span> ${escape(m[1])}`;
    })() : `${escape(d)}`} </li>`;
  })} </ul>`;
});
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_CharacterStore = subscribe(Character, (value) => $CharacterStore = value);
  $$unsubscribe_CharacterStore();
  return `<header id="character-sheet-header" class="row"><div class="col-one"><div class="label" data-svelte-h="svelte-wb83ye">Name</div> <h1 class="title">${escape($CharacterStore.name)}</h1></div> <div class="col-two"><div class="label" data-svelte-h="svelte-qzuppx">Class</div> <h2 class="title">${escape($CharacterStore.className)}</h2></div> <div class="col-one">${validate_component(Incrementer, "Incrementer").$$render($$result, { title: "Hit Points" }, {}, {
    default: () => {
...
const Power = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="local-row svelte-14f815r"><div class="local-col svelte-14f815r"><div class="local-row svelte-14f815r"><h2 class="sheet-title">${escape(title)} </h2> <span class="words svelte-14f815r">(${escape(uses)})</span></div></div> <div class="local-col svelte-14f815r"><div class="local-row row-right svelte-14f815r"><button class="btn primary button svelte-14f815r" ${uses === 0 ? "disabled" : ""}>use</button></div></div></div> <p class="words svelte-14f815r">${escape(body)}</p>`;
});
...
const AbilityScores = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="row scores svelte-r7mg46">${each(toPairs($CharacterStore.abilities), ([key, value]) => {
    return `<div class="col-one"><button type="button" class="clear-button svelte-r7mg46"><h3 class="score-title svelte-r7mg46">${escape(key)}</h3> <p class="score-title score svelte-r7mg46">${escape(value)}</p></button> </div>`;
  })} </div>`;
});
...
const Weapons = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${each($EquippedWeapons, (weapon) => {
    return `<div class="row weapon-row svelte-1qr1zos"><h2 class="col-two sheet-title">${escape(weapon.name)}</h2> <div class="col-one weapon-row svelte-1qr1zos">${escape(toDiceString(weapon.toHit))} 
			${validate_component(RollButton, "RollButton").$$render($$result, { dice: weapon.toHit }, {}, {})}</div> <div class="col-one weapon-row svelte-1qr1zos">${escape(toDiceString(weapon.damage))} 
			${validate_component(RollButton, "RollButton").$$render($$result, { dice: weapon.damage }, {}, {})}</div> </div>`;
  })}`;
});
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$unsubscribe_CharacterStore();
  return `${$CharacterStore === void 0 ? `wating...` : `${validate_component(Header, "Header").$$render($$result, {}, {}, {})} ${validate_component(AbilityScores, "Scores").$$render($$result, {}, {}, {})} ${validate_component(Weapons, "Weapons").$$render($$result, {}, {}, {})} ${validate_component(Armor, "Armor").$$render($$result, {}, {}, {})} <div class="row"><div class="col-two">${validate_component(Powers, "Powers").$$render($$result, {}, {}, {})}</div> <div class="col-two">${validate_component(Omens, "Omens").$$render($$result, {}, {}, {})}</div></div> ${validate_component(Equipment, "Equipment").$$render($$result, {}, {}, {})} ${validate_component(Features, "Features").$$render($$result, {}, {}, {})}`}`;
});
export {
  Page as default
};
